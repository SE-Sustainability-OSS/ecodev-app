...
def get_accessible_modules(auth: dict | AppUser,
                           project_id: int,
                           modules: list[Module],
                           session: Session,
                           ) -> list[Module]:
    ...
    accessible_modules = retrieve_accessible_modules(user, project_id, session)
...
def retrieve_accessible_modules(auth: dict | AppUser,
                                project_id: int,
